---
title: Create Task
description: "Submit a new interaction task."
---

## `POST /createTask`

Creates a new FInteractions task and returns a task ID for status polling.
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `type` | string | Yes | Must be `FInteractionsTask` |
...
| `ERROR_TASK_NOT_SUPPORTED` | 400 | Task type is not `FInteractionsTask` |
