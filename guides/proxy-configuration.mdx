...
description: "How to configure proxies for interaction tasks."
---
...
<AccordionGroup>
  <Accordion title="Use residential proxies">
    Residential proxies have the highest success rates because they appear as real user connections. Datacenter proxies may be flagged by FInteractions.
  </Accordion>
