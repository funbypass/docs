...
description: "How an interaction task moves from creation to completion."
---

## Overview

Every task request follows a predictable lifecycle. Understanding this flow helps you build robust integrations and handle edge cases.
...
<Steps>
  ...
  <Step title="Validation">
    ...
    - Task type must be `FInteractionsTask`
...
- If the task fails for any reason (proxy error, timeout, or incomplete interaction), the balance is **automatically refunded**
...
def run_task(client_key, task_params):
    # Create task
